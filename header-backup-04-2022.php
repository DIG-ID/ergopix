			...
			<div class="header-menu-container">
				<div class="header-menu-content">
					...
					?>
						...
						<div class="newmenu-tablet">
							<div class="container">
								<div class="row">
								
								<div class="col">
									<a href="<?php if(ICL_LANGUAGE_CODE=='de'): ?>https://www.ambassadorzermatt.com/familienurlaub-im-winter-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>https://www.ambassadorzermatt.com/en/family-holiday-in-winter-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>https://www.ambassadorzermatt.com/fr/vacances-en-famille-en-hiver-a-zermatt/
								<?php endif; ?>">
									<span>
						        	<?php if(ICL_LANGUAGE_CODE=='de'): ?>Familien
						        	<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>Families
						        	<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>Familles
						        	<?php endif; ?>
						        	</span>
						        	</a>
						        </div>
								...
								<div class="col">
									<a href="<?php if(ICL_LANGUAGE_CODE=='de'): ?>https://www.ambassadorzermatt.com/aktivurlaub-im-winter-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>https://www.ambassadorzermatt.com/en/active-holiday-in-winter-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>https://www.ambassadorzermatt.com/fr/des-vacances-actives-en-hiver-a-zermatt/
								<?php endif; ?>">
									<span>
						        	<?php if(ICL_LANGUAGE_CODE=='de'): ?>Aktive
						        	<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>Active people
						        	<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>Personnes actives
						        	<?php endif; ?>
						        	</span>
						        	</a>
						        </div>
								...
								<div class="col">
									<a href="<?php if(ICL_LANGUAGE_CODE=='de'): ?>https://www.ambassadorzermatt.com/ski-snowboard-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>https://www.ambassadorzermatt.com/en/winter-hiking-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>https://www.ambassadorzermatt.com/fr/ski-et-snowboard-a-zermatt/
								<?php endif; ?>">
									<span>
						        	<?php if(ICL_LANGUAGE_CODE=='de'): ?>Ski & Snowboard
						        	<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>Ski & Snowboard
						        	<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>Ski & Snowboard
						        	<?php endif; ?>
						        	</span>
						        	</a>
						        </div>
								...
								<div class="col">
									<a href="<?php if(ICL_LANGUAGE_CODE=='de'): ?>https://www.ambassadorzermatt.com/winterwandern-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>https://www.ambassadorzermatt.com/en/winter-hiking-in-zermatt/
								<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>https://www.ambassadorzermatt.com/fr/randonnee-hivernale-a-zermatt/
								<?php endif; ?>">
									<span>
						        	<?php if(ICL_LANGUAGE_CODE=='de'): ?>Winterwandern
						        	<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>Winter hiking
						        	<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>Randonnée hivernale
						        	<?php endif; ?>
						        	</span>
						        	</a>
						        </div>
	      		     	...
	      		     	<div class="newmenu container">
						    ...
						    <div class="row newmenu-items">
								...
								<?php endif; ?>"><div class="col-md-3 menu-a-blocks" style="background-image:url('/wp-content/uploads/2021/11/familie-ambassador-s.jpg');"><span>
						        	<?php if(ICL_LANGUAGE_CODE=='de'): ?>
						        	Familien
						        	<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
						        	Families
						        ...
						        <a href="<?php if(ICL_LANGUAGE_CODE=='de'): ?>
https://www.ambassadorzermatt.com/aktivurlaub-im-winter-in-zermatt/
<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
https://www.ambassadorzermatt.com/en/active-holiday-in-winter-in-zermatt/
<?php elseif(ICL_LANGUAGE_CODE=='fr'): ?>
https://www.ambassadorzermatt.com/fr/des-vacances-actives-en-hiver-a-zermatt/
<?php endif; ?>"><div class="col-md-3 menu-a-blocks" style="background-image:url('/wp-content/uploads/2021/11/aktiv-ambassador-s.jpg');"><span>
						        		<?php if(ICL_LANGUAGE_CODE=='de'): ?>
						        		Aktive
						        		<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
						        		Active people
...
<?php endif; ?>"><div class="col-md-3 menu-a-blocks" style="background-image:url('/wp-content/uploads/2021/11/ski-ambassador-s.jpg');"><span>
						        		<?php if(ICL_LANGUAGE_CODE=='de'): ?>
						        		Ski & Snowboard
						        		<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
						        		Ski & Snowboard
...
<?php endif; ?>"><div class="col-md-3 menu-a-blocks" style="background-image:url('/wp-content/uploads/2021/11/winterwandern-s.jpg');"><span>
						        		<?php if(ICL_LANGUAGE_CODE=='de'): ?>
						        		Winterwandern
						        		<?php elseif(ICL_LANGUAGE_CODE=='en'): ?>
						        		Winter hiking
	...
	<?php if(ICL_LANGUAGE_CODE=='de'){ ?>
		...
		<a href="https://www.ambassadorzermatt.com/luftreinigungsgeraete/" style="border:2px solid #9e0e0e;background:#9e0e0e;font-family: 'Work Sans';height: 150px;width: 45px;position:fixed;left:0px;top:400px;z-index: 99;font-size:18px;text-align: center;padding:14px 0;color:#ffffff;text-transform:uppercase;"><span style="transform: rotate(270deg);display: inline-block;white-space: nowrap;padding-top:30px;padding-bottom: 58px;letter-spacing: 2.67px;">News</span></a>
	<?php endif; ?>
	<?php } ?>
	<?php if(ICL_LANGUAGE_CODE=='en'){ ?>
		<?php if (is_front_page()): ?>
		<a href="https://www.ambassadorzermatt.com/en/air-purification-devices/" style="border:2px solid #9e0e0e;background:#9e0e0e;font-family: 'Work Sans';height: 150px;width: 45px;position:fixed;left:0px;top:400px;z-index: 99;font-size:18px;text-align: center;padding:14px 0;color:#ffffff;text-transform:uppercase;"><span style="transform: rotate(270deg);display: inline-block;white-space: nowrap;padding-top:30px;padding-bottom: 58px;letter-spacing: 2.67px;">News</span></a>
		<?php endif; ?>
	<?php } ?>
	<?php if(ICL_LANGUAGE_CODE=='fr'){ ?>
		<?php if (is_front_page()): ?>
		<a href="https://www.ambassadorzermatt.com/fr/purificateurs-dair/" style="border:2px solid #9e0e0e;background:#9e0e0e;font-family: 'Work Sans';height: 150px;width: 45px;position:fixed;left:0px;top:400px;z-index: 99;font-size:18px;text-align: center;padding:14px 0;color:#ffffff;text-transform:uppercase;"><span style="transform: rotate(270deg);display: inline-block;white-space: nowrap;padding-top:30px;padding-bottom: 58px;letter-spacing: 2.67px;">News</span></a>
		<?php endif; ?>
	<?php } ?>
